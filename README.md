...
If you want to use 'BUDDY' in large scale or in a more customizable manner, please stay tuned for [our latest release](https://github.com/Philipbear/pybuddy). You are welcome to contact me via **philipxsp@hotmail.com** should you have any questions or suggestions.
